...
public class Account extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1501174533129663088L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Account\",\"namespace\":\"example.avro\",\"fields\":[{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"iban\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public Account(java.lang.String name, java.lang.String iban) {
    this.name = name;
    this.iban = iban;
  }
   ...
   */
  public static example.avro.Account.Builder newBuilder() {
    return new example.avro.Account.Builder();
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static example.avro.Account.Builder newBuilder(example.avro.Account.Builder other) {
    if (other == null) {
      return new example.avro.Account.Builder();
    } else {
      return new example.avro.Account.Builder(other);
    }
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static example.avro.Account.Builder newBuilder(example.avro.Account other) {
    if (other == null) {
      return new example.avro.Account.Builder();
    } else {
      return new example.avro.Account.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Account>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(example.avro.Account.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(example.avro.Account other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Account.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Account.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Account.Builder setIban(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public example.avro.Account.Builder clearIban() {
      iban = null;
